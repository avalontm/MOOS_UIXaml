...
namespace MOOS.IO
{
    public abstract class IOPortBase
    {
        ...
        static public void Write8(UInt16 aPort, byte aData)
        {
        } // Plugged

        //[PlugMethod(PlugRequired = true)]
        static public void Write16(UInt16 aPort, UInt16 aData)
        {
        } // Plugged

        //[PlugMethod(PlugRequired = true)]
        static public void Write32(UInt16 aPort, UInt32 aData)
        {
        } // Plugged

        //[PlugMethod(PlugRequired = true)]
        static public byte Read8(UInt16 aPort)
        {
            return 0;
        } // Plugged

        //[PlugMethod(PlugRequired = true)]
        static public UInt16 Read16(UInt16 aPort)
        {
            return 0;
        } // Plugged
